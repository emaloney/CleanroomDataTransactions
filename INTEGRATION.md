...
```
github "emaloney/CleanroomDataTransactions" ~> 1.2.0
```

This specifies that Carthage use the latest version of CleanroomDataTransactions that is API-compatible with 1.2, i.e. any 1.2.*x* version.

**Note:** Be sure to check the [latest releases](https://github.com/emaloney/CleanroomDataTransactions/releases); there may be a newer version than 1.2 that is no longer API-compatible.
