...
The [`master`](https://github.com/emaloney/CleanroomDataTransactions) branch of this project is **Swift 2.2 compliant** and therefore **requires Xcode 7.3 or higher** to compile.

2 other branches are also available:

 - The [`swift2.3`](https://github.com/emaloney/CleanroomDataTransactions/tree/swift2.3) branch uses **Swift 2.3**, requiring Xcode 8.0
